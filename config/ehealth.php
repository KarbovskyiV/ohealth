...
return [
  ...
  */
    ...
    // Config params Preperson
    // https://e-health-ua.atlassian.net/wiki/spaces/ESOZ/pages/20233683284/DRAFT+Config+params+Preperson+ENT-057
    'preperson_healthcare_services_speciality_types' => [
        'ADOLESCENT_MEDICINE', 'AEROSPACE_MEDICINE', 'ALLERGOLOGY', 'ANAESTHETICS', 'ANALYTICAL_AND_CONTROL_PHARMACY',
        'AUDIOLOGY', 'BACTERIOLOGY', 'CARDIOLOGY', 'CARDIOVASCULAR_SURGERY', 'CLINICAL_BIOCHEMISTRY',
        'CLINICAL_DIAGNOSTIC', 'CLINICAL_IMMUNOLOGY', 'CLINICAL_LABORATORY', 'CLINICAL_PROVISOR', 'COMBUSTIOLOGY',
        'COMMON_HYGIENE', 'COMMUNAL_HYGIENE', 'DERMATO-VENEREOLOGY', 'DIETETICS', 'DISINFECTION', 'EMERGENCY_MEDICINE',
        'ENDOCRINOLOGY', 'ENDOSCOPY', 'EPIDEMIOLOGY', 'ERGOTHERAPEUTICS', 'FAMILY_DOCTOR', 'FOOD_HYGIENE',
        'FORENSIC_CRIMINOLOGY', 'FORENSIC_CYTOLOGY', 'FORENSIC_IMMUNOLOGY', 'FORENSIC_MEDICAL_EXAMINATION',
        'FORENSIC_MEDICAL_HISTOLOGY', 'FORENSIC_MEDICAL_TOXICOLOGY', 'FORENSIC_MEDICINE', 'FORENSIC_PSYCHIATRIC_EXAMINATION',
        'FUNCTIONAL_DIAGNOSTICS', 'GASTROENTEROLOGY', 'GENERAL_HEMATOLOGY', 'GENERAL_MEDICINE', 'GENERAL_SURGERY',
        'GERIATRICS', 'GYNECOLOGIC_ONCOLOGY', 'HYGIENE_LABORATORY', 'IMMUNOLOGY', 'INFECTIOUS_DISEASES',
        'LABORATORY_GENETICS', 'LABORATORY_IMMUNOLOGY', 'LABORATORY_RESEARCH_OF_ENVIRONMENTAL_FACTORS',
        'LABORATORY_RESEARCH_OF_ENVIRONMENT_CHEMICAL_FACTORS',
        'LABORATORY_RESEARCH_OF_ENVIRONMENT_PHYSICAL_FACTORS', 'MEDICAL_CASE_EMERGENCY_MEDICINE', 'MEDICAL_GENETICS',
        'MEDICAL_PSYCHOLOGY', 'MEDICAL_STATISTICS', 'MICROBIOLOGY', 'NARCOLOGY', 'NEONATOLOGY', 'NEPHROLOGY', 'NEUROLOGY',
        'NEUROSURGERY', 'NURSING', 'OBSTETRICS', 'OBSTETRICS_AND_GYNECOLOGY', 'OCCUPATIONAL_MEDICINE',
        'OCCUPATIONAL_PATHOLOGY', 'ONCOLOGY', 'ONCOTOLARYNGOLOGY', 'OPERATING_NURSING', 'OPHTHALMOLOGY', 'ORTHODONTOLOGY',
        'ORTHOPAEDICS', 'ORTHOPEDIC_DENTISTRY', 'OTORHINOLARYNGOLOGY', 'PARASITOLOGY', 'PATHOLOGIC_ANATOMY',
        'PATHOLOGY_LABORATORY', 'PEDIATRICIAN', 'PEDIATRIC_ALLERGY', 'PEDIATRIC_ANAESTHETICS', 'PEDIATRIC_CARDIOLOGY',
        'PEDIATRIC_DERMATO-VENEREOLOGY', 'PEDIATRIC_ENDOCRINOLOGY', 'PEDIATRIC_GASTROENTEROLOGY', 'PEDIATRIC_GYNECOLOGY',
        'PEDIATRIC_HEMATOLOGY', 'PEDIATRIC_HYGIENE', 'PEDIATRIC_IMMUNOLOGY', 'PEDIATRIC_INFECTIOUS_DISEASE',
        'PEDIATRIC_NEPHROLOGY', 'PEDIATRIC_NEUROLOGY', 'PEDIATRIC_ONCOLOGY', 'PEDIATRIC_OPHTHALMOLOGY',
        'PEDIATRIC_ORTHOPAEDICS', 'PEDIATRIC_OTOLARYNGOLOGY', 'PEDIATRIC_PATHOLOGY', 'PEDIATRIC_PHTHISIOLOGY',
        'PEDIATRIC_PSYCHIATRY', 'PEDIATRIC_PULMONOLOGY', 'PEDIATRIC_STOMATOLOGY', 'PEDIATRIC_SURGERY',
        'PEDIATRIC_UROLOGY', 'PHARMACEUTICS_ORGANIZATION', 'PHARMACIST', 'PHTHISIOLOGY',
        'PHYSICAL_MEDICINE_AND_REHABILITATION', 'PHYSICAL_THERAPEUTICS', 'PHYSICAL_THERAPY',
        'PHYSICAL_THERAPY_AND_SPORTS_MEDICINE', 'PHYSIOTHERAPY', 'PROCTOLOGY', 'PROVISOR', 'PSYCHIATRY',
        'PSYCHOPHYSIOLOGY', 'PSYCHOTHERAPY', 'PUBLIC_HEALTH_AND_PREVENTIVE_MEDICINE', 'PUBLIC_HEALTH_ORGANIZATION',
        'PULMONOLOGY', 'RADIATION_HYGIENE', 'RADIATION_THERAPY', 'RADIOLOGIC_DIAGNOSIS', 'RADIOLOGY', 'RECEPTIONIST',
        'REFLEXOLOGY', 'RHEUMATOLOGY', 'SANOLOGY', 'SEXOPATHOLOGY', 'SPORTS_MEDICINE', 'STOMATOLOGY',
        'SURGICAL_DENTISTRY', 'SURGICAL_ONCOLOGY', 'THERAPEUTIC_DENTISTRY', 'THERAPIST', 'THORACIC_SURGERY', 'TOXICOLOGY',
        'TRADITIONAL_ALTERNATIVE_MEDICINE', 'TRANSFUSIOLOGY', 'TRANSPLANTOLOGY', 'ULTRASONIC_DIAGNOSIS', 'UROLOGY',
        'VASCULAR_SURGERY', 'VIROLOGY', 'X_RAY_RADIOLOGY'
    ],
