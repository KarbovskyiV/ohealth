...
<div @if($hasLimit) x-data="{ limit: {{ $limit }} }" @endif>
                ...
                <div class="record-inner-grid-container">
                    <div
                        ...
                        <div>
                            ...
                            <div
                                class="record-inner-subvalue">{{ data_get($diagnosticReport, 'ehealthInsertedAt') }}</div>
                        </div>
                        ...
                        <div>
                            ...
                            <div
                                class="record-inner-subvalue">{{ data_get($diagnosticReport, 'conclusion', '-') }}</div>
                        </div>
                    </div>
                </div>
    ...
    @if($hasLimit)
        <div x-show="limit < {{ count($this->diagnosticReports) }}" class="flex justify-start mt-4">
            <button type="button"
                    @click="limit += 5"
                    class="item-add"
            >
