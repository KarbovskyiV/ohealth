    ...
    x-data="{
         ...
         get availableConfidantPersons() {
             ...
             return this.confidantPersons.filter(confidantPerson =>
                 confidantPerson.isActive
                 && ! existingAuthPersonUuids.includes(confidantPerson.person.uuid)
             );
         }
     }"
>
    <legend class="legend">{{ __('patients.add_auth_method_third_person') }}</legend>
    ...
    <table class="table-input w-full">
        ...
        <tbody>
            ...
            <template x-if="availableConfidantPersons.length === 0">
                <tr>
                    <td colspan="6" class="td-input py-8 text-center">
                        <div class="text-gray-500 dark:text-gray-400">
                            <p class="mb-2 text-lg font-medium">{{ __('patients.no_available_confidants') }}</p>
            ...
            <template x-if="availableConfidantPersons.length > 0">
                <template
                    x-for="(confidantPerson, confidantIndex) in availableConfidantPersons"
                ...
                >
                    ...
                    >
                        <tr>
                            ...
                            <td class="td-input text-center align-top" x-show="docIndex === 0">
                                <button
                                    type="button"
