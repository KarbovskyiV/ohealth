<div class="relative">
    ...
    >
        <legend class="legend">
            <h2>{{ __('procedures.rehabilitation_aids') }}</h2>
        </legend>
            ...
            <tbody>
                <template x-for="(usedCode, index) in modalProcedure.usedCodes">
                    <tr>
                        ...
                        <td class="td-input" x-text="dictionary[usedCode.code]"></td>
                        <td class="td-input">
                            ...
                            >
                                ...
                                <div class="absolute" style="left: 50%">
                                    ...
                                    >
                                        ...
                                        <button
                                            @click.prevent="
                                                modalProcedure.usedCodes.splice(index, 1);
                                                close($refs.button);
                                            "
                            ...
                            <form>
                                ...
                                <div class="mt-6 flex justify-between space-x-2">
                                    ...
                                    <button
                                        @click.prevent
                                        @click="
                                            modalProcedure.usedCodes = modalProcedure.usedCodes.filter((usedCode) =>
                                                Object.keys(dictionary).includes(usedCode.code),
                                            );
                                        ...
                                        ! Object.keys(dictionary).includes(modalUsedCode.code)"
                                    >
                                        {{ __('forms.save') }}
                                    </button>
                                </div>
