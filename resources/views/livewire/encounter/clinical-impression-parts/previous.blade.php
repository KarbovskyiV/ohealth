...
<div class="relative">
    ...
    >
        <legend class="legend">
            <h2>{{ __('clinical-impressions.previous') }}</h2>
        </legend>
        ...
        <table class="table-input w-inherit">
            ...
            <tbody>
                <template x-for="(previous, index) in modalClinicalImpression.previous">
                    <tr>
                        <td class="td-input" x-text="previous.ehealthInsertedAt || ''"></td>
                        <td class="td-input" x-text="`${previous.codeCode} - ${dictionary[previous.codeCode]}`"></td>
                        <td class="td-input">
                                ...
                                <div class="absolute" style="left: 50%">
                                    ...
                                    >
                                            ...
                                            @click="
                                                ...
                                                if ($wire.clinicalImpressions.length > 0) {
                                                    searchResults = JSON.parse(
                                                        JSON.stringify($wire.clinicalImpressions),
                                                    );
                                                    openModal = true;
                                                } else {
                                        ...
                                        <button
                                            ...
                                            @click.prevent="
                                                modalClinicalImpression.previous.splice(index, 1);
                                                close($refs.button);
                                            "
                                        >
                                            {{ __('forms.delete') }}
                                    ...
                                    <div class="table-container">
                                        <div class="overflow-visible">
                                            <table class="table-base">
                                                ...
                                                <tbody>
                                                    <template
                                                        x-for="clinicalImpression in searchResults"
                                                    ...
                                                    >
                                                        <tr class="border-b dark:border-gray-700">
                                                            ...
                                                            <td
                                                                class="td-input"
                                                                x-text="
                                                                    `${clinicalImpression.code.coding[0].code} - ${dictionary[clinicalImpression.code.coding[0].code]}`
                                                                "
                                                            ></td>
                                                            <td class="td-input">
                                                                <button
