...
>
                ...
                <div class="record-inner-action-col">
                    ...
                    >
                        @if ($isReadonly ?? false)
                            <a
                                href="#"
                                @click.prevent="openProblemDrawer = true"
                ...
                <div class="record-inner-grid-container">
                    <div class="grid w-full grid-cols-2 gap-x-4 gap-y-4 xl:grid-cols-3">
                        <div>
                            ...
                            <div class="record-inner-subvalue">1231-adsadas-aqeqe-casdda</div>
                        </div>
                        <div>
                        ...
                        <div>
                            <div class="record-inner-label">{{ __('patients.record_creation_date') }}</div>
    ...
    <div>
        @unless ($isReadonly ?? false)
            ...
            >
                {{ __('patients.add_detected_medical_device_problem') }}
            </button>
        @endunless
    </div>
        ...
        <form>
            ...
            >
                <fieldset class="fieldset">
                    ...
                    <div class="form-row-2">
                        <div class="form-group group">
                            ...
                            <label class="label">{{ __('patients.medical_device') }}</label>
                        </div>
                        <div class="form-group group">
                            <select class="input-select peer" required>
                                <option value="" disabled hidden></option>
                                <option value="1" selected>{{ __('patients.problem_present') }}</option>
                            </select>
                            <label class="label">{{ __('patients.record_status') }}</label>
                        </div>
                    </div>
                </fieldset>
                    ...
                    <div>
                            ...
                            <div class="form-group group relative flex justify-between">
                                <div class="datepicker-wrapper flex-1">
                                    <input
                                        ...
                                        value="02.04.2025"
                                    />
                                    <label class="wrapped-label">{{ __('patients.detection_date_and_time') }}</label>
                                </div>
                        ...
                        <div class="form-row-2 mt-4">
                            <div class="form-group group">
                                <select class="input-select peer" required>
                                    <option value="" disabled hidden></option>
                                    <option value="1" selected>{{ __('patients.broken') }}</option>
                                </select>
                                <label class="label">{{ __('patients.type_of_detected_problem') }}</label>
                            </div>
                        </div>

                        <div class="form-row-1 mt-4">
                            <div>
                                <label class="label-modal mb-2 block text-sm text-gray-500">{{ __('patients.problem_description') }}</label>
                                <div>
                                    <textarea
                                        class="textarea"
                                        rows="4"
                        ...
                        <div class="form-row-2 mt-4">
                            <div class="form-group group">
                                <select class="input-select peer">
                                    <option value="" disabled hidden></option>
                                    <option value="1" selected>Катетер Omnius 2000</option>
                                </select>
                                <label class="label">{{ __('patients.medical_device_caused_problem') }}</label>
                            </div>
                            <div class="form-group group">
                                <select class="input-select peer">
                                    <option value="" disabled hidden></option>
                                    <option value="1" selected>{{ __('patients.breakdown_01_03_2025') }}</option>
                                </select>
                                <label class="label">{{ __('patients.previous_detected_problem') }}</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-6 flex w-full justify-start space-x-4">
                    ...
                    @unless ($isReadonly ?? false)
                        <button type="button" @click="openProblemDrawer = false" class="button-primary">
                            {{ __('forms.add') }}
                        </button>
                    @endunless
                </div>
