    ...
    x-data="{
        ...
        loadIcd10Descriptions() {
            const icd10Codes = this.conditions
                ...
                .filter((code) => ! (code in this.icd10Descriptions));
        ...
        init() {
            ...
            this.$watch('conditions', () => this.loadIcd10Descriptions());
...
>
            ...
            <form class="space-y-6">
                ...
                >
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-2">
                        <div>
                            ...
                            >
                                <span x-text="modalCondition.codeSystem === 'eHealth/ICPC2/condition_codes' ? '{{ __('patients.add_icd10_code') }}' : '{{ __('patients.add_icpc2_code') }}'"></span>
                            </button>
                        </div>
                ...
                <div class="mt-8 flex items-center justify-start gap-4">
                    ...
                    @unless ($isReadonly)
                        ...
                        >
                            <span x-text="newCondition ? '{{ __('patients.add_diagnose') }}' : '{{ __('forms.save') }}'">
                            </span>
                        </button>
                    @endunless
                </div>
                <div class="mt-2 text-left">
                    <template x-if="showPrimaryWarning">
                        <p class="text-error">{!! __('patients.new_primary_diagnose') !!}</p>
                    </template>
    ...
    <x-dialog-drawer
        ...
        wire:ignore
    >
        <x-slot name="title">{{ __('patients.add_observations_reports_conditions') }}</x-slot>
