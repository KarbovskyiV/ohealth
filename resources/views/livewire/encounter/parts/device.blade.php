...
>
                ...
                <div class="record-inner-action-col">
                    ...
                    >
                        @if ($isReadonly ?? false)
                            <a
                                href="#"
                                @click.prevent="openDeviceDrawer = true"
            ...
            <div class="record-inner-body">
                <div class="record-inner-grid-container">
                    <div class="grid w-full grid-cols-2 gap-x-4 gap-y-4 xl:grid-cols-4">
                        <div>
                            <div class="record-inner-label">{{ __('patients.medical_device_model') }}</div>
                            <div class="record-inner-subvalue">Nimbus2000</div>
                        </div>
                        <div>
                            <div class="record-inner-label">{{ __('care-plan.medical_device_type') }}</div>
                        ...
                        <div>
                            ...
                            <div class="record-inner-subvalue">GlobalMeD</div>
                        </div>
                        <div>
                            <div class="record-inner-label">{{ __('patients.medical_device_serial_number') }}</div>
                            <div class="record-inner-subvalue">IncNSPX30</div>
                        </div>
                        <div>
    ...
    <div>
        @unless ($isReadonly ?? false)
            ...
            >
                {{ __('patients.add_medical_device') }}
            </button>
        @endunless
    </div>

    <x-dialog-drawer x-model="openDeviceDrawer" maxWidth="4/5" wire:ignore>
        <x-slot name="title">{{ __('patients.new_medical_device') }}</x-slot>
            ...
            >
                <fieldset class="fieldset">
                    ...
                    <div class="form-row-2">
                        <div class="form-group group">
                            <select class="input-select peer" required>
                                ...
                                <option value="1" selected>{{ __('patients.dilatation_catheters') }}</option>
                            </select>
                        ...
                        <div class="form-group group relative">
                            <input
                                ...
                                class="input peer"
                                placeholder=" "
                                value="Кардіостимулятор Medtronic Azure XT"
                                required
                            />
                            <label class="label">{{ __('patients.medical_device_name') }}</label>
                    ...
                    <div class="form-row-2">
                        <div class="form-group group">
                            <select class="input-select peer" required>
                                <option value="" disabled selected hidden></option>
                                <option value="1" selected>{{ __('patients.active_status') }}</option>
                            </select>
                ...
                <fieldset class="fieldset">
                    ...
                    <div>
                        <div class="form-row-2">
                            <div class="form-group group relative">
                                <input type="text" class="input peer" placeholder=" " value="1231FDSE" />
                            ...
                            <div class="form-group group">
                                <select class="input-select peer">
                                    <option value="" disabled selected hidden></option>
                                    <option value="1" selected>Medtronic Azure XT DR MRI</option>
                                </select>
                                <label class="label">{{ __('patients.medical_device_model_from_directory') }}</label>
                            </div>
                        </div>

                        <div class="form-row-2">
                            <div class="form-group group relative">
                                <input type="text" class="input peer" placeholder=" " value="GlobalMed, Inc" />
                                <label class="label">{{ __('patients.manufacturer') }}</label>
                                @icon('close', 'svg-input right-2.5 text-gray-400 cursor-pointer')
                            </div>
                            <div class="form-group group relative">
                                <input type="text" class="input peer" placeholder=" " value="NSPX30" />
                                <label class="label">{{ __('patients.medical_device_serial_number') }}</label>
                                @icon('close', 'svg-input right-2.5 text-gray-400 cursor-pointer')
                            </div>
                        </div>
                        ...
                        <div class="form-row-2">
                            <div class="form-group group relative">
                                <input type="text" class="input peer" placeholder=" " value="RZ12345678" />
                                <label class="label">{{ __('patients.medical_device_batch_number') }}</label>
                                @icon('close', 'svg-input right-2.5 text-gray-400 cursor-pointer')
                            </div>
                            <div class="form-group group relative">
                                <input type="text" class="input peer" placeholder=" " value="NSPX30" />
                            ...
                            <div class="form-group group">
                                <div class="datepicker-wrapper">
                                    <input
                                        ...
                                        value="02.04.2025"
                                    />
                                    <label class="wrapped-label">{{ __('patients.medical_device_production_date') }}</label>
                                </div>
                            </div>
                            <div class="form-group group">
                                <div class="datepicker-wrapper">
                                    <input
                                        ...
                                        value="02.04.2025"
                                    />
                                    <label class="wrapped-label">{{ __('patients.medical_device_expiration_date') }}</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row-2">
                            <div class="form-group group relative">
                                <input type="text" class="input peer" placeholder=" " value="OPA-12345678" />
                                <label class="label">{{ __('patients.medical_device_external_system_identifier') }}</label>
                                @icon('close', 'svg-input right-2.5 text-gray-400 cursor-pointer')
                            </div>
                            <div class="form-group group">
                                <select class="input-select peer">
                                    ...
                                    <option value="1" selected>
                                        {{ __('patients.medical_device_parent_device') }}
                                    </option>
                                </select>
                                <label class="label">{{ __('patients.medical_device_parent_device') }}</label>
                            </div>
                        </div>
                    </div>

                    <template x-for="(prop, index) in properties" :key="index">
                        <div :class="{ 'border-t border-gray-100 dark:border-gray-700 pt-6 mt-6': index > 0 }">
                                ...
                                <div class="form-row-2">
                                    <div class="form-group group">
                                        <select class="input-select peer">
                                            <option value="" disabled selected hidden></option>
                                            <option value="1" selected>
                                                {{ __('patients.medical_device_additional_property') }}
                                            </option>
                                        </select>
                                        <label class="label">{{ __('patients.medical_device_additional_property') }}</label>
                                    </div>
                                </div>
                                <button
                                    type="button"
                    ...
                    <div class="mt-2 mb-6">
                        <button
                            type="button"
                            @click.prevent="properties.push(1)"
                        ...
                        >
                            + {{ __('patients.add_additional_property') }}
                        </button>
                    </div>
                    ...
                    <div class="mt-6 border-t border-gray-100 pt-6 dark:border-gray-700">
                        ...
                        <div class="form-row-1 mt-4">
                            <div>
                                <label class="label-modal mb-2 block"> {{ __('patients.field_name') }} </label>
                                <div>
                                    <textarea
                                        class="textarea"
                                        rows="4"
                ...
                <div class="mt-6 flex w-full justify-start space-x-4">
                    ...
                    @unless ($isReadonly ?? false)
                        <button type="button" @click="openDeviceDrawer = false" class="button-primary">
                            {{ __('forms.add') }}
                        </button>
                    @endunless
                </div>
