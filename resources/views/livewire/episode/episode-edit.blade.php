...
>
                        ...
                        <div class="form-group group">
                            <div class="relative">
                                ...
                                <label
                                    for="startTime"
                                    class="wrapped-label"
                                >{{ __('episodes.period_start_time') }}</label>
                            </div>
    ...
    @if ($isDraft)
        <div x-data="{ open: false }" x-on:open-draft-deletion.window="open = true">
            <template x-teleport="body">
                ...
                >
                    <div x-transition.opacity class="fixed inset-0 bg-black/30" x-on:click="open = false"></div>

                    <div class="modal-wrapper">
                        <div
                            class="modal-content mx-auto w-full max-w-xl bg-white text-gray-900 dark:bg-gray-800 dark:text-gray-100"
                            x-on:click.stop
                            x-transition
                        ...
                        >
                            ...
                            <div class="flex items-center justify-start gap-4 border-t border-gray-200 pt-4 dark:border-gray-700">
                                <button type="button" x-on:click="open = false" class="button-minor">
                                    {{ __('forms.cancel') }}
                                </button>
