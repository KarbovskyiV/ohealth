                                    ...
                                    <div class="flex justify-center relative">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <button type="button" @click="close(); isSecretUpdated = false; openUpdateSecretDrawer = true" class="flex items-center gap-2 w-full px-4 py-2.5 text-left text-sm text-gray-600 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer">
