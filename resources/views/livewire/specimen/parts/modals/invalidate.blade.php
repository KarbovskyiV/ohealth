    ...
    <div class="p-6 md:p-8 text-left bg-white dark:bg-gray-800">
        ...
        <div class="form-row-2 mt-6">
            <div class="form-group group">
                ...
                <label for="invalidate-reason" class="label">
                    {{ __('specimens.invalidate_reason') }}*
                </label>
                @error('invalidateReason')
        ...
        <div class="mt-8 flex items-center justify-start gap-4">
            ...
            <button type="button" wire:click="invalidate" wire:loading.attr="disabled" class="button-danger min-w-30">
                <span wire:loading.remove wire:target="invalidate">
                    {{ __('specimens.invalidate') }}
                </span>
                <span wire:loading wire:target="invalidate">
                    ...
                </span>
            </button>
        </div>
