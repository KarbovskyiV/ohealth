...
return [
    ...
    */
    ...
    'onset_date' => 'Дата початку',
    'condition_start_date' => 'Дата початку стану',
    'asserted_date' => 'Створено',
    'doctor' => 'Лікар',
    'asserter_name' => 'ПІБ лікаря, що створив епізод',
    'asserter_text' => 'Коментар',
    ...
    'create_new_condition' => 'Створити новий стан',
    'new_evidence_condition' => 'Новий доказ - стан',
    'select_previously_registered_condition' => 'Обрати раніше зареєстрований стан',
    ...
    'body_sites' => 'Частина тіла',
    'add_body_part' => ' Додати частину тіла',
    'evidence' => 'Докази',
    'evidence_observations' => 'Спостереження',
    'evidence_details' => 'Додати спостереження, звіт або стан',
    'evidence_search' => 'Пошук',
