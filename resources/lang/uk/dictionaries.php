...
return [
    ...
    'medical_device' => [
        ...
        'skip_treatment_period' => 'Можливість створювати е-запит на такий самий медичний виріб протягом курсу лікування',
        'request_max_period_day' => 'Максимальна тривалість курсу лікування на який може бути виписаний е-запит за медичною програмою',
