    ...
    */
    ...
    'custom' => [
        ...
        'encounter' => [
            ...
            'hospitalization' => [
                'admit_source_required_if' => "Джерело госпіталізації є обов'язковим для типу взаємодії 'Виписка'",
                'destination_not_active' => 'Заклад, куди направляється пацієнт, не є активним',
                'destination_required_if' => "Заклад, куди направляється пацієнт після виписки, є обов'язковим, якщо пацієнта переведено до іншого закладу",
                'discharge_disposition_required_if' => "Куди вибув пацієнт після виписки є обов'язковим для типу взаємодії 'Виписка'",
                'discharge_department_required_if' => "Відділення, з якого виписано пацієнта, є обов'язковим для типу взаємодії 'Виписка'"
            ],
            'actions' => [
            ...
            'actionReferences' => [
                'required_activity' => 'Потрібно додати щонайменше одну послугу категорії «консультування», діагностичний звіт або процедуру',
